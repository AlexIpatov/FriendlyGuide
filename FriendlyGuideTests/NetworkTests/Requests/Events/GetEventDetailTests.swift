...
class GetEventDetailTests: XCTestCase {
    ...
    let id = 1
    let model = EventDetail(title: "w", eventDescription: "", firstSubtitle: "", secondSubtitle: "", boolSubtitle: false, images: [], shortPlace: EventPlace(title: "", address: "", phone: "", subway: "", siteURL: "", isClosed: false, coords: Coordinates(lat: 0.0, lon: 0.0), location: ""), bodyText: "", dates: [], siteURL: "")
