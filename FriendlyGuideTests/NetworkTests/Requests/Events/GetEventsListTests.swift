...
class GetEventsListTests: XCTestCase {
  //  "https://kudago.com/public-api/v1.4/events?lang=ru&location=spb&actual_since=1444385206&fields=id,title,images,dates"
    ...
    func testGetEventsList() throws {
        ...
        request.load(cityTag: endPoint.cityTag, actualSince: endPoint.actualSince) { response in
